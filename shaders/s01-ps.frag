...
// Original code: https://www.shadertoy.com/view/MdGGzy
/*
...
//float EPSILON_NRM	= 0.1 / ub.param1.x;
...
//float SEA_TIME = ub.param1.z * SEA_SPEED;
float SEA_TIME = 0;
...
float map(vec3 p) {
    ...
    SEA_TIME = ub.param1.z * SEA_SPEED;
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
  ...
  EPSILON_NRM	= 0.1 / ub.param1.x;

  vec2 uv = v_texcoord.xy;
	//vec2 uv = fragCoord.xy / ub.param1.xy;
  uv = uv * 2.0 - 1.0;
  uv.x *= ub.param1.x / ub.param1.y;    
  float time = ub.param1.z * 0.3;
